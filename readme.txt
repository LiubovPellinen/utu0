...
>The using of the table construction for the product basket is not a good idea in the real project. But I use it simply like an example of using table construction on >web-page.
######**1.index.html**.
...
```
2.Font size of links  and became  smaller   by clicking on it.
```
...
```
Handling of event “clicking on the icon of navigation menu”.
```
.header .menu-btn:checked ~ .menu {
    max-height: 240px;
  }
